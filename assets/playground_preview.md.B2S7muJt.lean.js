import{C as e,R as t,T as n,V as r,_ as i,b as a,x as o}from"./chunks/vue.runtime.esm-bundler._50JsNDg.js";import{p as s}from"./chunks/client.Bu1W3SRG.js";var c={style:{position:`fixed`,inset:`0`,width:`96px`,height:`96px`,margin:`auto`,"pointer-events":`none`},width:`512`,height:`512`,viewBox:`0 0 512 512`,fill:`none`,xmlns:`http://www.w3.org/2000/svg`},l=n({__name:`preview`,setup(e){let{isDark:n}=s();return t(()=>{let e=localStorage.getItem(`elysia-playground:preview`);e&&(/<[^>]+>/.test(e)||(e=`<style>
@font-face {
