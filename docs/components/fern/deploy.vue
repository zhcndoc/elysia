    ...
    >
        ...
        >
        	<div class="relative flex justify-center items-center overflow-hidden lg:overflow-visible size-72 sm:size-96 md:size-128">
	            <motion.div v-bind="fadeIn()" class="absolute size-36 rotate-45 border-t border-l border-b border-mauve-300 dark:border-mauve-700 rounded-full" />
	            <motion.div v-bind="fadeIn()" class="absolute size-52 border-t border-l border-mauve-200 dark:border-mauve-700 rounded-full" />
	            <motion.div v-bind="fadeIn()" class="absolute size-68 rotate-45 border-l border-mauve-200 dark:border-mauve-700 rounded-full" />
	            <motion.div v-bind="fadeIn()" class="absolute size-84 rotate-45 border-r border-mauve-200 dark:border-mauve-700 rounded-full" />
	            <motion.div v-bind="fadeIn()" class="absolute size-52 rotate-45 border-r border-mauve-200 dark:border-mauve-700 rounded-full" />

	            <motion.div v-bind="fadeIn()" class="hidden lg:block absolute size-164 rotate-45 border-l border-mauve-200 dark:border-mauve-700 rounded-full" />
	            <motion.div v-bind="fadeIn()" class="hidden lg:block absolute size-148 border-l border-t border-mauve-200 dark:border-mauve-700 rounded-full" />
        	</div>
