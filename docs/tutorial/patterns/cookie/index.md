...
head:
    - - meta
      - property: 'og:title'
        content: Cookie - Elysia 教程

    - - meta
      - name: 'description'
        content: 学习如何在 Elysia 中管理 cookies，包括设置、获取和保护您的 Web 应用程序的 cookies。
...
我们可以使用 <DocLink href="/patterns/cookie.html#cookie-schema">cookie schema</DocLink> 来验证和解析 cookie。
...
请查看 <DocLink href="/patterns/cookie.html#cookie-attribute">Cookie 属性</DocLink>。
