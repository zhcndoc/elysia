...
head:
    - - meta
      - property: 'og:title'
        content: 介绍 - Elysia 教程

    - - meta
      - name: 'description'
        content: Elysia 提供了一个互动教程体验，让您通过 IDE、游乐场等来学习 Elysia。立即开始使用 Elysia 吧！
...
您可以通过点击左侧边栏的 <Bookmark class="inline" :size="18" stroke-width="2" /> 来查看 API 文档。
